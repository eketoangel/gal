...
init python:
    gui.init(1920, 1080)
init python:
     style.default.outlines = [ (2, "#000000", 0, 1),  ]
...
## порядку.
define gui.namebox_borders = Borders(6, 1, 6, 1)
...
define gui.button_borders = Borders(1, 1, 1, 1)
...
## Генерируем рамки.
define gui.frame_borders = Borders(6, 6, 6, 16)
